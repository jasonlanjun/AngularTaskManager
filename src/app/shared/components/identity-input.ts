...
@Component({
  ...
  template: `
    <div>
      <mat-form-field>
        <mat-select placeholder="Type" (change)="onIdTypeChange($event.value)" [(ngModel)]="identity.identityType">
    ...
    <div class="id-input">
      <mat-form-field class="full-width">
        <input matInput type="text" placeholder="ID" (change)="onIdNoChange($event.target.value)" [(ngModel)]="identity.identityNo">
...
export class IdentityInputComponent implements ControlValueAccessor, OnInit, OnDestroy {
  ...
  identityTypes: {value: IdentityType, label: string}[] = [
    {value: IdentityType.IdCard, label: 'PR'},
    {value: IdentityType.Insurance, label: 'DL'},
