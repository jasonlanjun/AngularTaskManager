...
@Component({
  ...
  template: `
    <div [formGroup]="form" class="age-input">
      <div>
        <mat-form-field>
          <input matInput [matDatepicker]="birthPicker" type="text" placeholder="DOB" formControlName="birthday">
      ...
      <ng-container formGroupName="age">
        <div class="age-num">
          <mat-form-field>
            <input matInput type="number" placeholder="Age" formControlName="ageNum">
          </mat-form-field>
        </div>
        <div>
        ...
        <mat-error class="mat-body-2" *ngIf="form.get('age')?.hasError('ageInvalid')">Age</mat-error>
      </ng-container>
    </div>
    `,
  styles: [`
